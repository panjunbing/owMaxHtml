...
/**
 	* A data access object (DAO) providing persistence and search support for AnswerBlanks entities.
...
public class AnswerBlanksDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(AnswerBlanksDAO.class);
		//property constants
    ...
    public AnswerBlanks findById( Integer id) {
        ...
        try {
            AnswerBlanks instance = (AnswerBlanks) getSession()
                    .get("com.owmax.model.AnswerBlanks", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding AnswerBlanks instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public AnswerBlanks merge(AnswerBlanks detachedInstance) {
        ...
        try {
            AnswerBlanks result = (AnswerBlanks) getSession()
