...
/**
 	* A data access object (DAO) providing persistence and search support for Questions entities.
...
public class QuestionsDAO extends BaseHibernateDAO  {
    ...
    public Questions findById( Integer id) {
        ...
        try {
            Questions instance = (Questions) getSession()
                    .get("com.owmax.model.Questions", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Questions merge(Questions detachedInstance) {
        ...
        try {
            Questions result = (Questions) getSession()
