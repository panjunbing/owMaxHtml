...
/**
 	* A data access object (DAO) providing persistence and search support for QuestionnaireUser entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.owmax.model.QuestionnaireUser
  * @author MyEclipse Persistence Tools 
 */
@Repository
public class QuestionnaireUserDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(QuestionnaireUserDAO.class);
		//property constants
    ...
    public QuestionnaireUser findById( Integer id) {
        ...
        try {
            QuestionnaireUser instance = (QuestionnaireUser) getSession()
                    .get("com.owmax.model.QuestionnaireUser", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding QuestionnaireUser instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public QuestionnaireUser merge(QuestionnaireUser detachedInstance) {
        ...
        try {
            QuestionnaireUser result = (QuestionnaireUser) getSession()
