 ...
 * Selections entities. Transaction control of the save(), update() and delete()
...
public class SelectionsDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(SelectionsDAO.class);
	// property constants
	public static final String SELECTION = "selection";
	public static final String SELECTION_TEXT = "selectionText";

	public void save(Selections transientInstance) {
	...
	public void delete(Selections persistentInstance) {
	...
	public Selections findById(Integer id) {
		log.debug("getting Selections instance with id: " + id);
		try {
			Selections instance = (Selections) getSession().get(
					"com.owmax.model.Selections", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Selections instance) {
	...
	public Selections merge(Selections detachedInstance) {
		log.debug("merging Selections instance");
		try {
			Selections result = (Selections) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Selections instance) {
